...
#include "TangiAbilityTagMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FTangiAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UTangiAbilityTagMapping : public UDataAsset
{
	GENERATED_BODY()
public:
...
private:
	...
	TArray<FTangiAbilityTagRelationship> AbilityTagRelationships;
};
